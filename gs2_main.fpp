...
!!    call gs_reset
  ...
  subroutine gs2_trin_init (rhoc, qval, shat, aspr, kap, tri, ntspec, dens, temp, fprim, tprim, nu)
    ...
    integer, intent (in) :: ntspec
    real, intent (in) :: rhoc, qval, shat, aspr, kap, tri, dens, fprim
    real, dimension (:), intent (in) :: temp, tprim, nu

    call init_trin_species (ntspec, dens, temp, fprim, tprim, nu)
    call init_trin_geo (rhoc, qval, shat, aspr, kap, tri)
