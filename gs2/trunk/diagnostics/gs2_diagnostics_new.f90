...
!
  ...
  subroutine create_dimensions
    ...
    use simpledataio, only: SDATIO_UNLIMITED, add_dimension
    implicit none
    ...
    !SHOULD WE MAKE THESE DIMENSION STRINGS MODULE LEVEL PARAMETERS WHICH ARE USED
    !THIS WILL ALLOW US TO CHANGE THE SYMBOL IN JUST ONE PLACE IF REQUIRED?
