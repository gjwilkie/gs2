...
# ifdef MPI
    ...
    i1 = i
    call mpi_reduce &
         (i1, i, 1, MPI_INTEGER, MPI_SUM, dest, mp_comm, ierror)
# else
...
# ifdef MPI
    ...
    i1 = i
    call mpi_reduce &
         (i1, i, size(i), MPI_INTEGER, MPI_SUM, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, 1, MPI_LOGICAL, MPI_LOR, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, 1, mpireal, MPI_SUM, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, size(a), mpireal, MPI_SUM, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    z1 = z
    call mpi_reduce &
         (z1, z, 1, mpicmplx, MPI_SUM, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    z1 = z
    call mpi_reduce &
         (z1, z, size(z), mpicmplx, MPI_SUM, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_allreduce &
         (i1, i, 1, MPI_INTEGER, MPI_SUM, mp_comm, ierror)
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_allreduce &
         (i1, i, size(i), MPI_INTEGER, MPI_SUM, mp_comm, ierror)
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_allreduce &
         (a1, a, 1, mpireal, MPI_SUM, mp_comm, ierror)
# endif
  ...
  subroutine sum_allreduce_real_array (a)
    ...
    real, dimension (:), intent (in out) :: a
# ifdef MPI
!<DDHACK>    real, dimension (size(a)) :: a1
    integer :: ierror
!<DDHACK>    a1 = a
    call mpi_allreduce &
!<DDHACK<         (a1, a, size(a), mpireal, MPI_SUM, mp_comm, ierror)
...
# ifdef MPI
    ...
    z1 = z
    call mpi_allreduce &
         (z1, z, 1, mpicmplx, MPI_SUM, mp_comm, ierror)
# endif
  ...
  subroutine sum_allreduce_complex_array (z)
    ...
    complex, dimension (:), intent (in out) :: z
# ifdef MPI
!<DDHACK>    complex, dimension (size(z)) :: z1
    integer :: ierror
!<DDHACK>    z1 = z
    call mpi_allreduce &
!<DDHACK>         (z1, z, size(z), mpicmplx, MPI_SUM, mp_comm, ierror)
         (MPI_IN_PLACE, z, size(z), mpicmplx, MPI_SUM, mp_comm, ierror) !<DDHACK>
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_reduce &
         (i1, i, 1, MPI_INTEGER, MPI_MAX, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
  ...
  subroutine max_reduce_integer_array (i, dest)
    ...
    integer, intent (in) :: dest
# ifdef MPI
!<DDHACK>    integer, dimension (size(i)) :: i1
    integer :: ierror
!<DDHACK>    i1 = i
    if(iproc.eq.dest) then
       call mpi_reduce &
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, 1, mpireal, MPI_MAX, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_allreduce &
         (i1, i, 1, MPI_INTEGER, MPI_MAX, mp_comm, ierror)
# endif
...
!<DDHACK>    i1 = i
    call mpi_allreduce &
!<DDHACK>         (i1, i, size(i), MPI_INTEGER, MPI_MAX, mp_comm, ierror)
...
# ifdef MPI
    ...
    a1 = a
    call mpi_allreduce &
         (a1, a, 1, mpireal, MPI_MAX, mp_comm, ierror)
# endif
...
!<DDHACK>    a1 = a
    call mpi_allreduce &
!<DDHACK>         (a1, a, size(a), mpireal, MPI_MAX, mp_comm, ierror)
...
# ifdef MPI
    ...
    i1 = i
    call mpi_reduce &
         (i1, i, 1, MPI_INTEGER, MPI_MIN, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_reduce &
         (i1, i, size(i), MPI_INTEGER, MPI_MIN, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, 1, mpireal, MPI_MIN, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_reduce &
         (a1, a, size(a), mpireal, MPI_MIN, dest, mp_comm, ierror)
# else
    if (dest /= 0) call error ("reduce to")
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_allreduce &
         (i1, i, 1, MPI_INTEGER, MPI_MIN, mp_comm, ierror)
# endif
...
# ifdef MPI
    ...
    i1 = i
    call mpi_allreduce &
         (i1, i, size(i), MPI_INTEGER, MPI_MIN, mp_comm, ierror)
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_allreduce &
         (a1, a, 1, mpireal, MPI_MIN, mp_comm, ierror)
# endif
...
# ifdef MPI
    ...
    a1 = a
    call mpi_allreduce &
         (a1, a, size(a), mpireal, MPI_MIN, mp_comm, ierror)
# endif
