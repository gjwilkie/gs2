...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do iglo=g_lo%llim_proc, g_lo%ulim_proc
       ...
       do isgn=1,2
          ...
          do ig=-ntgrid, ntgrid-1
             ...
             g0(ig,isgn,iglo) = 0.5*spec(is)%dens*conjg(havg)*havg
    ...
    do iglo=g_lo%llim_proc, g_lo%ulim_proc
       ...
       do isgn=1,2
          ...
          do ig=-ntgrid, ntgrid-1
             ...
             g0(ig,isgn,iglo) = spec(is)%dens*wdrift(ig,isgn,iglo)*conjg(havg)*havg
    ...
    if (proc0) then
       ...
       do is = 1, nspec
          do ie = 1,negrid
             he(ie) % vdrift(is) = he(ie) % vdrift(is) &
                   + real(tote(ie,is))
          end do
       end do
    end if
