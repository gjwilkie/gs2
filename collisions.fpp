...
module collisions
  ...
  end interface add_apar_drag_term
  ...
  logical :: test
  logical :: new_apar_coll, special_wfb_lorentz
...
contains
  ...
  subroutine read_parameters
    ...
    namelist /collisions_knobs/ collision_model, conserve_moments, &
         ...
         use_le_layout, new_apar_coll, special_wfb_lorentz
